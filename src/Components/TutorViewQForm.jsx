  ...
  return (
    <div className="center_piece">
      ...
      <div>
        ...
        <h2 style={{color: 'darkorange'}} className="header-centered">{parseCode(parseTopic(topicName, changedTopics))}</h2>
        {isEditing && <h3 style={{color: 'darkorange'}} className="header-centered">
    ...
    <small className="listItem">
      ...
      <ul className="supported-links">
        ...
        <li>
          <strong>Image:</strong> Google Drive, Dropbox, or Giphy. Copy the shareable link from each site.
        </li>
      </ul>
    </small>    
    </div>
